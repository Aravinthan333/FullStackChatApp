...
import { anomationDefaultOptions, getColor } from "@/lib/utils";
...
const NewDM = () => {
  ...
  const [openNewConactModal, setOpenNewConactModal] = useState(false);
  ...
  return (
    <>
        ...
        <Tooltip>
          <TooltipTrigger>
            <FaPlus
              ...
              onClick={() => setOpenNewConactModal(true)}
            />
          </TooltipTrigger>
      ...
      <Dialog open={openNewConactModal} onOpenChange={setOpenNewConactModal}>
          ...
          {searchedContacts.length <= 0 && (
            <div className="flex-1 md:bg-[#1c1d25] md:flex mt-5 md:mt-0 flex-col justify-center items-center duration-1000 transition-all">
              <Lottie
                ...
                height={100}
                width={100}
                options={anomationDefaultOptions}
              />
